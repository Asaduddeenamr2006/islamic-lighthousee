...
export default function TafsirPanel({ surah, onClose }: TafsirPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#080a0f] flex flex-col">
      {/* Header */}
      <div className="flex items-center justify-between px-3 sm:px-6 py-3 sm:py-4 bg-[#0f1219] border-b border-white/10 flex-shrink-0">
        <div className="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
          ...
          >
            {TAFSIR_SOURCES.map(source => (
              <option key={source.id} value={source.id} className="bg-[#0f1219]">
                {source.name}
              </option>
            ))}
          </select>
