...
export default function AudioPlayer({
  ...
  return (
    <div className="h-16 sm:h-20 bg-[#0f1219]/90 backdrop-blur-md border-t border-white/5 flex items-center px-2 sm:px-4 gap-2 sm:gap-3 relative">
      {/* Reciter Dropdown */}
      {showReciterList && (
        <div className="absolute bottom-full right-2 sm:right-4 mb-1 bg-[#0f1219] border border-white/10 rounded-xl shadow-2xl overflow-hidden z-50 w-64 max-h-64 overflow-y-auto">
