...
export default function Sidebar({ surahs, loading, selectedSurah, onSelectSurah, isOpen, onClose }: SidebarProps) {
  return (
    <>
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed top-0 right-0 h-full w-full sm:w-80 md:w-72 lg:w-80 bg-[#0f1219] border-l border-white/5 z-50 transform transition-transform duration-300 ease-out ${isOpen ? 'translate-x-0' : 'translate-x-full'} lg:translate-x-0 lg:static lg:z-0`}
      >
        {/* Header */}
