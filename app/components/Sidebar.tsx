...
export default function Sidebar({ surahs, loading, selectedSurah, onSelectSurah, isOpen, onClose }: SidebarProps) {
  return (
    <>
      {/* Overlay */}
      <div 
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed top-0 right-0 h-full w-full sm:w-80 md:w-72 lg:w-80 bg-[#1a1d26] border-l border-white/5 z-50 transform transition-transform duration-300 ease-out ${isOpen ? 'translate-x-0' : 'translate-x-full'} lg:translate-x-0 lg:static lg:z-0`}
      >
        {/* Header */}
        ...
        <div className="p-3 border-b border-white/5">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-10 pl-4 pr-10 bg-white/5 border border-white/10 rounded-lg text-white text-sm placeholder:text-white/40 focus:outline-none focus:border-green-500/50 transition-colors"
            />
          </div>
        </div>
