    ...
    <div className="min-h-screen bg-[#080a0f]">
      ...
      <main className="p-4 sm:p-6 lg:p-8">
        <div className="max-w-4xl mx-auto">
          {/* Hadith Card */}
          <div className="rounded-2xl border border-white/10 bg-[#0f1219] overflow-hidden shadow-xl mb-8">
            {/* Card Header */}
          ...
          {/* Explanation */}
          <div className="rounded-2xl border border-white/10 bg-[#0f1219] overflow-hidden shadow-xl">
            {/* Explanation Header */}
            <div className="px-4 sm:px-6 py-4 border-b border-white/5">
